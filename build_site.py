...
SITE = {
    ...
    "youtube_channel": "https://www.youtube.com/@WooHooMediaIndia",
...
CAPABILITIES = [
    ...
    ("03 / AI", "AI-native <em>cinema.</em>", "Generative pipelines: Kling, Seedance, Flux, Nano Banana, Soul characters."),
...
def render_capability(num, title, body):
